    ...
    <main className="min-h-screen flex flex-col items-center justify-center p-8 max-w-3xl mx-auto">
      <div className="w-full space-y-8">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl font-bold text-white tracking-tight">Ducope</h1>
          <p className="text-lg text-slate-400">Meme Token Launcher</p>
        </div>

        <div className="bg-slate-900/50 border border-slate-800 rounded-xl p-6 space-y-4">
          <h2 className="text-sm font-bold text-slate-300 tracking-wider">WHAT IT DOES</h2>
          <p className="text-sm text-slate-400 leading-relaxed">
            Turn your DeFi losses into viral meme tokens. When a swap fails, cope harder by minting a token about it.
          </p>
        </div>
