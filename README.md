<div align="center">
  ...
  <p><em>Error-state meme token minter. Failed swap = you're now a founder.</em></p>
  
  [![Live Demo](https://img.shields.io/badge/Live-Demo-brightgreen.svg)](https://dumfun.vercel.app)
  [![Pitch Video](https://img.shields.io/badge/Pitch-Video-red.svg)](https://youtube.com/your-video)
  [![GitHub](https://img.shields.io/badge/GitHub-Repository-black.svg)](https://github.com/edycutjong/frontier-dumfun)
</div>
...
Error-state meme token minter. Failed swap = you're now a founder.

**Ducope** solves this by providing: 
Error-state meme token minter. Failed swap = you're now a founder.
...
1. **Clone the repo:**
   ```bash
   git clone https://github.com/edycutjong/frontier-dumfun.git
   cd frontier-dumfun
   ```
